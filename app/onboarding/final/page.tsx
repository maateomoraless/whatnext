...
export default function OnboardingFinalPage() {
  ...
  return (
    <main className="flex min-h-screen justify-center bg-[#0a0a0a] px-6 text-white">
      <section className="mx-auto flex min-h-screen w-full max-w-[400px] flex-col items-center pb-12 pt-12">
        ...
        <p className="mb-8 text-center text-sm text-neutral-400">Basada en tus gustos · Actualizada</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-1.5 text-[11px] text-neutral-400">
                    <span className="h-2 w-2 rounded-full" style={{ backgroundColor: item.platformColor }} />
                    <span>{item.platform}</span>
                    <span>·</span>
                    <span>{item.genre}</span>
                  </div>
                  <div className="mt-2.5 h-[2px] w-full rounded-full bg-[#2a2a2a]">
                    <div className="h-full rounded-full bg-white" style={{ width: `${item.score}%` }} />
                  </div>
                </div>
              </div>
            </motion.article>
